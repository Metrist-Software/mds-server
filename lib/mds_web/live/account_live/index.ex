defmodule MdsWeb.AccountLive.Index do
  use MdsWeb, :live_view

  alias MdsData.Accounts
  alias MdsData.Accounts.Account
  ...
  @impl true
  def handle_info({MdsWeb.AccountLive.FormComponent, {:saved, account}}, socket) do
